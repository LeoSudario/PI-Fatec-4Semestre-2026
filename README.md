...
_(Após rodar o script, os novos arquivos JSON serão injetados magicamente no projeto React!)_
...
_Escaneie o QR Code usando o app "Expo Go" em seu smartphone Android/iOS._
