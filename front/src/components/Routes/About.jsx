    ...
    <section className="about__section">
      <div className="about__container">
        ...
        <p className="about__lead">
          ...
          <strong> Desenvolvimento de Software Multiplataforma (DSM)</strong> — Fatec Franca. O
          objetivo do PI é integrar conhecimentos de diversas disciplinas em um produto funcional,
        ...
        <ul className="about__list">
          ...
          <li>
            <strong>Integração IoT</strong> (opcional): botões físicos podem acionar
            check-in/checkout via HTTP seguro (X-API-Key) ou publicar eventos em MQTT; o backend
            processa e atualiza a ocupação.
          </li>
          <li>
            <strong>Deploy</strong> do backend na Render, expondo uma URL pública em HTTPS acessível
            por web e mobile.
          </li>
        </ul>
        ...
        <ul className="about__list">
          <li>
            Autenticação de usuários (login/cadastro) com armazenamento seguro do token no app.
          </li>
          ...
          <li>
            Integração com dispositivos físicos para incrementar/decrementar ocupação (HTTP/MQTT).
          </li>
          <li>
            Configuração do backend via variáveis de ambiente e app.config (Expo) para fácil troca
            de ambiente.
          </li>
        </ul>
        ...
        <ul className="about__list">
          <li>
            <strong>Frontend Mobile:</strong> React Native (Expo)
          </li>
          <li>
            <strong>Web (opcional):</strong> React
          </li>
          <li>
            <strong>Backend:</strong> Node.js, Express, JWT
          </li>
          <li>
            <strong>Banco de Dados:</strong> (por exemplo) MongoDB Atlas ou PostgreSQL
          </li>
          <li>
            <strong>IoT:</strong> HTTP (X-API-Key) e/ou MQTT (broker externo)
          </li>
          <li>
            <strong>Deploy:</strong> Render (Web Service, HTTPS público)
          </li>
        </ul>
